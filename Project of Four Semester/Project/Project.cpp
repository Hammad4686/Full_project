...
int main()
{
    ...
    else if (select == 3)
    {
        ...
        if (r.option == 1)
        {
            cout << endl;
            cout << "================" << endl;
            cout << "Total Bill : " << h.GetVal() + r.CalLaxuary() << endl;
            cout << "================" << endl;
        }
        else if (r.option == 2)
        {
            cout << endl;
            cout << "================" << endl;
            cout << "Total Bill : " << h.GetVal() + r.CalFamily() << endl;
            cout << "================" << endl;
        }
        else if (r.option == 3)
        {
            cout << endl;
            cout << "================" << endl;
            cout << "Total Bill : " << h.GetVal() + r.CalNormal() << endl;
            cout << "================" << endl;
        }
    }
